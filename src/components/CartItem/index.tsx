...
const CartItem: React.FC<CartItemType> = ({ id, title, imageUrl, price, count, size, type }) => {
	...
	return (
		<div className="cart__item">
			...
			<div className="cart__item-count">
				...
				<button className="button button--outline button--circle cart__item-count-minus" onClick={() => onClickMinus(count)} disabled={count === 1 ? true : false}>
